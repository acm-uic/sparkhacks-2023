...
export default function ContactUs(){
    ...
    return (
        <div className={"grid min-h-[500px] sm:h-screen sm:bg-primary place-items-center mt-5"}>
            <div className="absolute text-center h-fit w-full min-w-max px-2 py-10 sm:w-1/2 sm:drop-shadow-[-90px_-60px_4px_rgba(0,0,0,0.5)] sm:bg-secondary-light sm:rounded-[2.813rem]">
                <h1>Contact Us!</h1>
